...
void loop() {
  ...
  if (sig != 0) { //補正
    x = (x*463700)/(140200+sqrt(x**2+28900));
    y = (y*463700)/(140200+sqrt(y**2+28900));
  }
  if (y_sig != 0) {
    yg_x = (yg_x*463700)/(140200+sqrt(yg_x**2+28900));
    yg_y = (yg_y*463700)/(140200+sqrt(yg_y**2+28900));
  }
  if (b_sig != 0) {
    bg_x = (bg_x*463700)/(140200+sqrt(bg_x**2+28900));
    bg_y = (bg_y*463700)/(140200+sqrt(bg_y**2+28900));
  } 
