...
obj_color_orange =   [(47, 100, 20, 127, 28, 127)]      # Orange Ball
obj_color_yellow =   [(30, 100, -62, 33, 34, 127)]      # Yellow Goal
obj_color_blue   =   [(25, 10, -13, 8, -39, -6)]     # Blue Goal
...
# check Orange Ball
    i_o = 0
    balls_o1 = img.find_blobs(obj_color_orange, pixels_threshold=100, area_threshold=100)
