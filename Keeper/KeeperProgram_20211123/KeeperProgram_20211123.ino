...
void loop() {
  ...
  if (y_sig != 0) {
    yg_x = -(yg_x * 1491297) / (5551518 + 39291 * sqrt(yg_x * yg_x + 19600));
    yg_y = (yg_y * 932073) / (5551518 + 39291 * sqrt(yg_y * yg_y + 19600));
    }
    if (b_sig != 0) {
    bg_x = -(bg_x * 1491297) / (5551518 + 39291 * sqrt(bg_x * bg_x + 19600));
    bg_y = (bg_y * 932073) / (5551518 + 39291 * sqrt(bg_y * bg_y + 19600));
  }
        ...
        if(y <= 0){
          if(goal_sig == 0){
            ...
            if(goal_y <= 35 && abs(goal_x) < 10){
              ...
              motorfunction(z, abs(goal_x) + abs(goal_y)*2.5, -gyro);
            }
          }
        } else {
