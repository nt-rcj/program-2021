...
obj_color_orange =   [(40, 100, 26, 127, -128, 127)]      # Orange Ball
obj_color_yellow =   [(34, 72, -14, 0, 24, 127)]      # Yellow Goal
obj_color_blue   =   [(24, 43, -12, 0, -43, -18)]     # Blue Goal
...
sensor.set_auto_gain(False, gain_db = 24.63) # must be turned off for color tracking
sensor.set_auto_whitebal(False, rgb_gain_db = (63.36, 60.21, 64.24)) # must be turned off for color tracking
clock = time.clock()
